...
st.sidebar.markdown('')
see_cpa = st.sidebar.selectbox('Click here to see the cpa product classification 👉',['See CPA classification, Hide CPA classification'])
if see_cpa=='See CPA classification':
